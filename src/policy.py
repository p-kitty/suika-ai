...
Growing into valleys of big fruits is judged by the result (merges, danger) rather than crushed by the gap junk penalty.
...
def _evaluate_drop(
    ...
    # Valleys of big fruits are growing slots. Not crushed by height, wrong_side or ideal.
