...
Concrete procedures (growing priority, push-ins, cascade gaps) are not required.
Only merging, danger avoidance, burying, rolling accidents and gap junk are pinned.
"""
